    ...
    <div className="fixed inset-0 w-full h-full bg-black flex flex-col items-center justify-center p-4 overflow-clip touch-none overscroll-none drag-region">
      {isTVEnvironment ? (
        ...
        <>
          ...
          <div className="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] bg-primary/30 blur-[100px] rounded-full pointer-events-none mix-blend-screen" />
          <div className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-purple-900/40 blur-[100px] rounded-full pointer-events-none mix-blend-screen" />
        </>
      )}
        ...
        <div className="p-8 md:p-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-4" autoComplete="on">
            ...
            <Focusable
              ...
              className="w-full bg-primary hover:bg-primary-hover text-white font-bold h-12 rounded-xl transition-all shadow-lg hover:shadow-primary/25 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
