  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="absolute top-[-20%] right-[-20%] w-[70%] h-[70%] bg-primary/20 blur-[120px] rounded-full pointer-events-none" 
      />
      <motion.div 
        animate={{ 
          scale: [1, 1.5, 1],
        ...
        className="absolute bottom-[-20%] left-[-20%] w-[70%] h-[70%] bg-blue-900/20 blur-[120px] rounded-full pointer-events-none" 
      />
